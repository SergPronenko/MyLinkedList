...
public class Truck  extends GasolineCar{
    ...
    public Truck(String model, String number, String vin, DriverLicense.Category category, int cc, int hp, Transmission transmission, Trailer trailer, int emptyWeight, int loadedWeight) {
        super(model, number, vin, category, cc, hp, transmission, trailer);
