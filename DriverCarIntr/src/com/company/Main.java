...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Trailer trailer = new Trailer("AA7777AA","10050", Trailer.Category.C);
        GasolineCar car = new GasolineCar("ZAZ", "AA5555AA", "100500" , DriverLicense.Category.C ,
                                1499 , 80 , GasolineCar.Transmission.AUTOMATIC,trailer);
        Route route = new Route(car , johnDriver , "Troeshina" , "Klovska",trailer);
